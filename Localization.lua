...
L["Part %d"] = true
L["Parts"] = true
L["Please post bugs at |cFF00FFFFhttps://github.com/MailBuddy82/MailBuddy/issues|r. When posting bugs, indicate your locale and MailBuddy's version number v%s."] = true
